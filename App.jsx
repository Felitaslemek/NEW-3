        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          {modalContent === 'menu' && (
            <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-md p-6">
              ...
              <h2 className="text-xl font-semibold mb-4 text-center">Selamat Datang!</h2>
              <p className="text-gray-600 mb-6 text-center">
                Silakan masuk untuk melanjutkan atau buat akun baru.
              </p>
          ...
          {modalContent === 'login' && <LoginPage onClose={closeModal} />}
          {modalContent === 'signup' && <SignupPage onClose={closeModal} />}
        </div>
      )}
